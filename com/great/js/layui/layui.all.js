    ...
    M.prototype.config = {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({
                ...
                headers: n.headers || {},
                success: function (t) {
                    var tempCount = getGvalue(t, r.countName) || 0;
                    t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, tempCount), d(), n.time = (new Date).getTime() - a.startTime + " ms"), i && l.close(i), "function" == typeof n.done && n.done(t, e, t[r.countName])
                },
                error: function (e, t) {
                    a.layMain.html('<div class="' + f + '">数据接口请求异常</div>'), a.renderForm(), i && l.close(i)
                }
            })
        } else if (n.data && n.datcounta.constructor === Array) {
        ...
        var c = this, s = c.config, u = getGvalue(e, s.response.dataName) || [],  y = [], p = [], m = [],
            v = function () {
